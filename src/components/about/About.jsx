            ...
            <div className="flex flex-col items-center justify-start text-center sm:w-1/3 sm:py-8">
              ...
              <div className="flex items-center justify-center gap-3 pt-5 text-xl social-icons ">
                <a
                  ...
                  target="_blank"
                  className="p-2 duration-500 bg-gray-400 dark:bg-gray-700/70 dark:hover:bg-facebook-color rounded-xl hover:bg-facebook-color"
                >
                ...
                <a
                  ...
                  target="_blank"
                  className="p-2 duration-500 bg-gray-400 dark:bg-gray-700/70 dark:hover:bg-twitter-color rounded-xl hover:bg-twitter-color"
                >
                ...
                <a
                  ...
                  target="_blank"
                  className="p-2 duration-500 bg-gray-400 dark:bg-gray-700/70 dark:hover:bg-linkedin-color rounded-xl hover:bg-linkedin-color"
                >
                ...
                <a
                  ...
                  target="_blank"
                  className="p-2 duration-500 bg-gray-400 dark:bg-gray-700/70 dark:hover:bg-github-color rounded-xl hover:bg-github-color"
                >
